...
final class BSIRenewalHeader extends PKIHeader {
  private static final Logger LOG = Logger.getLogger(BSIRenewalHeader.class.getName());

  @SuppressWarnings("PMD.LongVariable")
  public static final ASN1ObjectIdentifier OID_BSI_CERT_REQ_MSGS_WITH_OUTER_SIG =
      new ASN1ObjectIdentifier("0.4.0.127.0.7.4.1.1.2");

  public BSIRenewalHeader() {
  ...
  public ASN1Primitive toASN1Primitive() {
    ...
    return OID_BSI_CERT_REQ_MSGS_WITH_OUTER_SIG;
  }
